...
const ChatPage = () => {
    const [messages, setMessages] = useState([
      { sender: "Timothy", text: "Hi, my name is Timothy. I'm your personal assistant for shopping with ABC Clothing. Ask me anything." },
    ...
    const [input_rows, setInputRows] = useState(1);
    ...
    return (
      <div className="flex flex-col h-screen w-screen bg-stone-900 text-white">
        {/* Header */}
        <div className="flex items-center justify-between mx-32 my-4">
          ...
          <div className="flex items-center gap-4 text-sm">
            ...
            <button className="px-4 py-1 rounded-md bg-slate-600 text-slate-200 hover:bg-slate-500 transition-colors">Update</button>
          </div>
        </div>
  
        {/* Chat Messages */}
        <div className="flex flex-1 mx-32 my-8 space-x-4 overflow-y-auto">  
          {/* Message Section */}
        ...
        {/* Input Section */}
        <div className="flex items-bottom mx-32 my-4">
            <textarea
            ...
            />
          <button
            className="ml-4 w-24 h-16 bg-slate-600 text-slate-200 hover:bg-slate-500 transition-colors rounded-md flex items-center justify-center"
            onClick={sendMessage}
          >
            →
          </button>
